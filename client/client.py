...
# cur.execute('''CREATE TABLE IF NOT EXISTS  persons(id integer, first_name text, last_name text, country text, profession text, PRIMARY KEY(id))''')
...
rows = session.execute( "INSERT INTO barak.Barak (userid, name, age, last_update_timestamp) VALUES ('9876', 'Amit', 2, toTimeStamp(now()));")

rows = session.execute("SELECT * FROM barak.Barak")
